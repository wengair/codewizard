...
Question.create!(description: "Which iterator does not return something?", options: [".map", ".each", ".select", ".find"], answer: ".each", level: Level.all[4])
...
Question.create!(description: "Which symbol do you use to set an instance variable?", options: ["()", "$", "#", "@"], answer: "@", level: Level.all[9])
